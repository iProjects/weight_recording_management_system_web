...
namespace test_service_ui
{
    ...
    public class SplashScreen : System.Windows.Forms.Form
    {
        ...
        public static string app_name = "weight recording test Service app";
        ...
        System.Windows.Forms.Timer elapsed_timer = new System.Windows.Forms.Timer();
        private ProgressBar progressBar1; // Doesn't require any args
        ...
        public SplashScreen()
        {
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished SplashScreen initialization", TAG));
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlStatus.Location = new System.Drawing.Point(36, 53);
            ...
            this.lblTimeRemaining.Location = new System.Drawing.Point(36, 9);
            this.lblTimeRemaining.Name = "lblTimeRemaining";
            this.lblTimeRemaining.Size = new System.Drawing.Size(86, 16);
            ...
            this.lblStatus.Location = new System.Drawing.Point(36, 31);
            ...
            this.lblappname.Location = new System.Drawing.Point(36, 118);
            ...
            this.lblbuildversion.Location = new System.Drawing.Point(36, 139);
            this.lblbuildversion.Name = "lblbuildversion";
            this.lblbuildversion.Size = new System.Drawing.Size(279, 16);
            this.lblbuildversion.TabIndex = 5;
            this.lblbuildversion.Text = "build version";
            // 
            // lbltimelapsed
            // 
            this.lbltimelapsed.BackColor = System.Drawing.Color.Transparent;
            this.lbltimelapsed.Location = new System.Drawing.Point(36, 164);
            this.lbltimelapsed.Name = "lbltimelapsed";
            this.lbltimelapsed.Size = new System.Drawing.Size(279, 16);
            this.lbltimelapsed.TabIndex = 7;
            this.lbltimelapsed.Text = "working";
            // 
            // progressBar1
            // 
            this.progressBar1.Location = new System.Drawing.Point(36, 83);
        ...
        private void SplashScreen_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                elapsed_timer.Tick += elapsed_timer_Elapsed; // Uses an event instead of a delegate
                elapsed_timer.Start(); // Start the timer

                _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished SplashScreen load", TAG));
        ...
        private void elapsed_timer_Elapsed(object sender, EventArgs e)
        {
            try
            {
                ...
                string time_lapsed = string.Format("{0} : {1} : {2} : {3}", t.Days, t.Hours, t.Minutes, t.Seconds);

                lbltimelapsed.Text = time_lapsed;

                _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(time_lapsed, TAG));
    ...
    public class RegistryAccess
    {
        ...
        private const string COMPANY_NAME = "weight recording test Service app";
        private const string APPLICATION_NAME = "weight recording test Service app";
